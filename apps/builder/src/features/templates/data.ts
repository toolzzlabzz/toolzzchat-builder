...
export const templates: TemplateProps[] = [
  ...
  {
    name: 'Mapear novo ICP',
    emoji: '🔎',
    category: 'marketing',
    description: 'Mapeia um novo segmento ou ICP',
    fileName: 'icp.json',
  },
  {
    name: 'Criar um novo site',
    emoji: '💻',
    category: 'marketing',
    description: 'Cria um novo site usando Greatpages',
    fileName: 'criar-site.json',
  },
  {
    name: 'Teste de UX',
    emoji: '🎨',
