      ...
      >
        <Stack spacing="6" maxW="300px" minW={[0, '300px']}>
          <Heading as="h1" data-aos="fade">
            Experiencia facil de construção
          </Heading>
          <Text
            color="gray.400"
            ...
            data-aos="fade"
          >
            Tudo o que você precisa fazer é arrastar e soltar blocos para criar
            seu aplicativo. Mesmo se você tiver necessidades personalizadas,
            você sempre pode adicionar código personalizado.
          </Text>
          <Flex>
            <Button
              as={Link}
