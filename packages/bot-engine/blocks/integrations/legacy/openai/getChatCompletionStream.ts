...
<<<<<<<< HEAD:packages/bot-engine/blocks/integrations/openai/getChatCompletionStream.ts
...
>>>>>>>> upstream/main:packages/bot-engine/blocks/integrations/legacy/openai/getChatCompletionStream.ts
