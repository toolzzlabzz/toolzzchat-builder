...
<<<<<<<< HEAD:packages/bot-engine/blocks/integrations/openai/parseChatCompletionMessages.ts
...
>>>>>>>> upstream/main:packages/bot-engine/blocks/integrations/legacy/openai/parseChatCompletionMessages.ts
