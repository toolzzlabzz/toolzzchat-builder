...
<<<<<<<< HEAD:packages/bot-engine/blocks/integrations/openai/createChatCompletionOpenAI.ts
...
>>>>>>>> upstream/main:packages/bot-engine/blocks/integrations/legacy/openai/createChatCompletionOpenAI.ts
import {
